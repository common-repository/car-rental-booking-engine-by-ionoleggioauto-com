...
function c_h_h_validate_form(){
	...
	var arr_pu_date = val_pu_date.split('-');
	var arr_do_date = val_do_date.split('-');
	
	jQuery('#pickupDateTime').val(arr_pu_date[2] + '-' + arr_pu_date[1] + '-' + arr_pu_date[0] + 'T' + decodeURIComponent(jQuery('#pu_time').val()));
	jQuery('#returnDateTime').val(arr_do_date[2] + '-' + arr_do_date[1] + '-' + arr_do_date[0] + 'T' + decodeURIComponent(jQuery('#do_time').val()));
	jQuery('#pu_location').val(encodeURI(jQuery('#pu_location').val()));
	jQuery('#do_location').val(encodeURI(jQuery('#do_location').val()));

	jQuery('#pickupName').val(encodeURI(jQuery('#pickupName').val()));

	jQuery('#pickupID').val(encodeURI(jQuery('#pickupID').val()));
